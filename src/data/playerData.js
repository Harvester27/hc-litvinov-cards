...
export const playerData = [
    ...
    { 
      ...
      birthPlace: 'Litvínov',
      catchingHand: 'L',
      description: 'Zkušený brankář, dvojka za Michaelou Novákovou. Chytal výhru nad Warriors 3:1, přestřelku 7:6 s Netopýři, prohru 4:7 s Kocouři na Kladně a výhru 4:2 nad Viper Ústí.'
    },
    { 
      id: 'seidler-jakub',
      name: 'Jakub Seidler', 
      ...
      birthPlace: 'Most',
      catchingHand: 'R',
      description: 'Třetí brankář týmu. Talentovaný gólman s perspektivou.'
    },
    { 
      id: 'moravek-jiri',
      name: 'Jiří Morávek', 
    ...
    { 
      ...
      joinedTeam: '2018',
      shoots: 'L',
      description: 'Nejzkušenější obránce týmu. Tvrdý defenzivní specialista.'
    },
    { 
      id: 'coufal-lubos',
      name: 'Luboš Coufal', 
      ...
      joinedTeam: '2020',
      shoots: 'R',
      description: 'Zkušený obránce s výbornou přihrávkou. Zaznamenal 2 asistence ve výhře 10:3 nad Gurmány. Výjimečně hrál v útoku proti Viper Ústí.'
    },
    { 
      id: 'turecek-tomas',
      name: 'Tomáš Tureček', 
      ...
      joinedTeam: '2021',
      shoots: 'L',
      description: 'Univerzální obránce, který dokáže v nouzi zaskočit i v brance. Chytal ve dvou zápasech základní skupiny ČP - proti Gurmánům (výhra 10:3) a Ducks Klášterec (prohra 3:6).'
    },
    { 
    ...
    { 
      ...
      joinedTeam: '2022',
      shoots: 'R',
      description: 'Ofenzivní obránce s výbornou střelou. Ve výhře 10:3 nad Gurmány měl 1+2, proti Sharks fantastické 2+2! Někdy až moc emotivní - nesportovní chování proti Kocourům.'
    },
    { 
      ...
      joinedTeam: '2015',
      shoots: 'L',
      description: 'Veterán týmu, otec tří synů hrající v útoku. Legenda klubu. Ve výhře 10:3 nad Gurmány vstřelil gól - celá rodina Schubadů skórovala! Pravidelně hraje se syny.'
    },
    { 
      id: 'kores-michal',
      name: 'Michal Koreš', 
      ...
      joinedTeam: '2021',
      shoots: 'R',
      description: 'Fyzicky silný obránce. Specialista na osobní souboje.'
    },
    { 
      id: 'kocourek-ondrej',
    ...
    { 
      ...
      joinedTeam: '2018',
      shoots: 'L',
      description: 'Rychlý a technický útočník. Vstřelil 2 góly ve výhře 10:3 nad Gurmány, gól proti Ducks. Asistence na první gól proti Viper Ústí.'
    },
    { 
      id: 'hruby-ondrej',
      name: 'Ondřej Hrubý', 
    ...
    { 
      ...
      joinedTeam: '2018',
      shoots: 'L',
      description: 'Starší z bratrů Matuškových. Zkušený útočník s dobrou střelou.'
    },
    { 
      id: 'matuska-lukas',
      name: 'Lukáš Matuška', 
      ...
      joinedTeam: '2023',
      shoots: 'R',
      description: 'Mladší z bratrů Matuškových, technický hráč. Vstřelil svůj první gól sezóny v prohře 4:7 s Kocouři na Kladně.'
    },
    { 
      id: 'benes-roman',
      name: 'Roman Beneš', 
