      ...
      <div class="space-y-6">
        ...
        <div class="relative overflow-hidden rounded-2xl bg-gradient-to-br from-red-600 via-red-700 to-gray-900 p-8 text-white shadow-2xl">
          ...
          <div class="relative z-10">
            ...
            <p class="text-xl text-white/90 mb-6">Mezinárodní hokejový turnaj plný dramatických bojů</p>
          ...
          <div class="relative mb-12">
            ...
            <div class="ml-16">
              ...
              <div class="bg-blue-50 rounded-xl p-4 mb-4">
                <h5 class="font-bold text-blue-900 mb-2">🎯 Průběh zápasu</h5>
              ...
              <div class="bg-gradient-to-r from-yellow-50 to-yellow-100 rounded-xl p-4 mb-4 border border-yellow-300">
                <div class="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div class="text-yellow-700 font-semibold">Řádil v zápase - 4 góly proti Alpha Team A!</div>
                ...
                <a href="/turnaje/hobby-cup-litvinov-2025/zapas-5" class="block bg-white rounded-xl p-4 shadow-md hover:shadow-xl transition-all border-l-4 border-green-600">
                  <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center gap-4">
                      <div class="text-right">
                        <div class="font-bold">HC Litvínov Lancers</div>
                        <div class="text-sm text-green-600 font-semibold">✔ Výhra 2 body</div>
                      </div>
                      <img src="/images/loga/lancers-logo.png" alt="Lancers" class="w-12 h-12" />
                    </div>
                  </div>
              ...
              <div class="space-y-3">
                <a href="/turnaje/hobby-cup-litvinov-2025/zapas-9" class="block bg-gradient-to-r from-amber-50 to-white rounded-xl p-4 shadow-md hover:shadow-xl transition-all border-2 border-amber-400">
                  ...
                  <div class="mt-3 bg-red-50 rounded-lg p-3">
                    <div class="font-semibold text-red-900 mb-2">📊 Dramatický průběh zápasu:</div>
        ...
        <!-- Shrnutí turnaje -->
        <div class="bg-gradient-to-r from-blue-50 to-white rounded-2xl p-6 shadow-lg">
          <h3 class="text-2xl font-black text-gray-900 mb-4">📝 Shrnutí turnaje</h3>
          <p class="text-gray-700 mb-4">
        ...
        <!-- Poděkování -->
        <div class="bg-gradient-to-r from-red-600 to-red-700 text-white rounded-xl p-6 text-center">
          <h4 class="text-2xl font-bold mb-4">Děkujeme! ❤️</h4>
