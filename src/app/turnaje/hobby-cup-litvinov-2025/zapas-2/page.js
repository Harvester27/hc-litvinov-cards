...
export default function Zapas2Page() {
  // Data zápasu
  const matchData = {
    id: 2,
    ...
    referee: 'TBA',
    attendance: 'TBA',
    periods: ['1:0', '1:0'], // Jen 2 třetiny
    overtime: false,
    shootout: false,
    notes: 'Druhý zápas pátečního programu - hrálo se pouze na 2 třetiny po 20 minutách',
    duration: '2x20 minut'
  };
  ...
  const rosters = {
    team1: {
      ...
      defenders: [
        ...
        { number: '', name: 'Maurice Giese', position: 'Obránce', penalties: 2 },
        { number: '', name: 'Nikita Helm', position: 'Obránce', goals: 1, assists: 0 },
        { number: '', name: 'Mark Wassermann', position: 'Obránce' }
      ],
      forwards: [
        { number: '', name: 'Alexander Plinger', position: 'Útočník', assists: 1, penalties: 2 },
        { number: '', name: 'Andrey Schapovalov', position: 'Útočník' },
        { number: '', name: 'Dennis Schuler', position: 'Útočník' },
        { number: '', name: 'Sergey Schnarr', position: 'Útočník', goals: 1, assists: 0 },
    ...
    team2: {
      ...
      forwards: [
        { number: '', name: 'Matthias Blaschzik', position: 'Útočník' },
        ...
        { number: '', name: 'Felix Schliemann', position: 'Útočník' },
        { number: '', name: 'Daniel Pietsch', position: 'Útočník' },
        { number: '', name: 'Jan Fritche', position: 'Útočník' },
        { number: '', name: 'Peter Angrik', position: 'Útočník' },
  ...
  const gameEvents = [
    { time: '11:00', period: 1, type: 'goal', team: 'team1', scorer: 'Sergey Schnarr', assists: [], score: '1:0' },
    { time: '20:00', period: 1, type: 'penalty', team: 'team2', player: 'Tim Bartsch', reason: 'Podražení', duration: 2 },
    { time: '21:00', period: 1, type: 'penalty', team: 'team1', player: 'Maurice Giese', reason: 'Sekání', duration: 2 },
    { time: '31:00', period: 2, type: 'goal', team: 'team1', scorer: 'Nikita Helm', assists: ['Alexander Plinger'], score: '2:0' },
    { time: '33:00', period: 2, type: 'penalty', team: 'team1', player: 'Alexander Plinger', reason: 'Sekání', duration: 2 },
    { time: '37:00', period: 2, type: 'penalty', team: 'team2', player: 'Daety Ertel', reason: 'Hrubost', duration: 2 }
  ];
      ...
      <div className="relative mt-28 mb-8 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 py-8">
          ...
          <div className="flex items-center gap-2 text-gray-400 mb-6">
            ...
            <ChevronRight className="w-4 h-4" />
            <span className="text-white font-bold">Zápas #2</span>
          </div>
                ...
                <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-yellow-500/20 to-orange-500/20 border border-yellow-500/30 p-4">
                  ...
                  <div className="relative flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <div className="text-white font-black text-lg">Sergey Schnarr</div>
                        <div className="text-yellow-400 text-sm font-semibold">Alpha Team A</div>
                      </div>
                    </div>
                    <div className="text-right">
                      <div className="text-3xl font-black bg-gradient-to-b from-yellow-400 to-orange-500 bg-clip-text text-transparent">1</div>
              ...
              <div className="space-y-3">
                <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-purple-500/20 to-blue-500/20 border border-purple-500/30 p-4">
                  ...
                  <div className="relative flex items-center justify-between">
                    ...
                    <div className="text-right">
                      <div className="text-3xl font-black bg-gradient-to-b from-purple-400 to-blue-500 bg-clip-text text-transparent">1</div>
                      <div className="text-xs text-gray-400 font-bold">1G + 0A</div>
                    </div>
                  </div>
                </div>
                ...
                <div className="rounded-2xl bg-white/5 border border-white/10 p-4">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-right">
                      <div className="text-2xl font-black text-white">1</div>
                      <div className="text-xs text-gray-400 font-bold">0G + 1A</div>
                    </div>
                  </div>
                </div>
              </div>
