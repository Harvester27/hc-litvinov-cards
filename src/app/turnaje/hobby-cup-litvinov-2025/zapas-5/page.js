...
import { 
  ...
  BarChart3, Percent, Sparkles
} from 'lucide-react';

export default function Zapas5Page() {
  // Data zápasu
  const matchData = {
    id: 5,
    ...
    referee: 'TBA',
    attendance: 'TBA',
    periods: ['2:2', '2:2'], // Jen 2 třetiny
    overtime: true,
    shootout: false,
    notes: 'Dramatický zápas rozhodnutý až v prodloužení!',
    duration: '2x20 minut + prodloužení'
  };
  ...
  const rosters = {
    team1: {
      ...
      defenders: [
        { number: '2', name: 'Guido Martin', position: 'Obránce' },
        { number: '7', name: 'Leon Wäser', position: 'Obránce' },
        { number: '15', name: 'Marco Rensch', position: 'Obránce', goals: 1, assists: 0 },
        { number: '13', name: 'Tim Bartsch', position: 'Obránce' }
      ],
      forwards: [
        { number: '10', name: 'Matthias Blaschzik', position: 'Útočník', goals: 1, assists: 1 },
        { number: '11', name: 'Frank Blaschzik', position: 'Útočník' },
        { number: '12', name: 'David Weiss', position: 'Útočník' },
        { number: '5', name: 'Ricardo Pietsch', position: 'Útočník', goals: 1, assists: 0 },
        { number: '6', name: 'Felix Schliemann', position: 'Útočník' },
        { number: '14', name: 'Daniel Pietsch', position: 'Útočník', assists: 1 },
        { number: '4', name: 'Jan Fritche', position: 'Útočník' },
        { number: '9', name: 'Peter Angrik', position: 'Útočník', goals: 1, assists: 0 },
        { number: '8', name: 'Daety Ertel', position: 'Útočník' }
      ]
    },
    team2: {
      name: 'HC Litvínov Lancers',
      goalies: [
        { number: '', name: 'Tomáš Kodrle', position: 'Brankář' }
      ],
      defenders: [
        { number: '22', name: 'Jindřich Belinger', position: 'Obránce' },
        { number: '11', name: 'Jiří Belinger', position: 'Obránce', assists: 1 },
        { number: '54', name: 'Ondřej Kocourek', position: 'Obránce' },
        { number: '3', name: 'Jiří Šalanda', position: 'Obránce', penalties: 2 }
      ],
      forwards: [
        { number: '67', name: 'Gustav Toman', position: 'Útočník', assists: 1 },
        { number: '98', name: 'Václav Matějovič', position: 'Útočník', goals: 2, assists: 0 }, // + vítězný gól v prodloužení
        { number: '95', name: 'Jan Švarc', position: 'Útočník', assists: 1 },
        { number: '94', name: 'Stanislav Švarc', position: 'Útočník', goals: 1, assists: 0, penalties: 2 },
        { number: '93', name: 'Ladislav Černý', position: 'Útočník', goals: 1, assists: 0 },
        { number: '91', name: 'Michal Klečka', position: 'Útočník', goals: 1, assists: 0 }
      ]
    }
  };
  ...
  const gameEvents = [
    { time: '11:00', period: 1, type: 'goal', team: 'team1', scorer: 'Peter Angrik', assists: [], score: '1:0' },
    { time: '13:00', period: 1, type: 'goal', team: 'team2', scorer: 'Michal Klečka', assists: [], score: '1:1' },
    { time: '19:00', period: 1, type: 'goal', team: 'team1', scorer: 'Marco Rensch', assists: ['Matthias Blaschzik'], score: '2:1' },
    { time: '19:00', period: 1, type: 'goal', team: 'team2', scorer: 'Ladislav Černý', assists: ['Gustav Toman'], score: '2:2' },
    { time: '21:00', period: 2, type: 'goal', team: 'team2', scorer: 'Václav Matějovič', assists: ['Jan Švarc'], score: '2:3' },
    { time: '31:00', period: 2, type: 'goal', team: 'team1', scorer: 'Ricardo Pietsch', assists: ['Daniel Pietsch'], score: '3:3' },
    { time: '33:00', period: 2, type: 'goal', team: 'team2', scorer: 'Stanislav Švarc', assists: ['Jiří Belinger'], score: '3:4' },
    { time: '34:00', period: 2, type: 'goal', team: 'team1', scorer: 'Matthias Blaschzik', assists: [], score: '4:4' },
    { time: '36:00', period: 2, type: 'penalty', team: 'team2', player: 'Stanislav Švarc', reason: 'Nedovolené bránění', duration: 2 },
    { time: '39:00', period: 2, type: 'penalty', team: 'team2', player: 'Jiří Šalanda', reason: 'Podražení', duration: 2 },
    { time: '43:47', period: 3, type: 'goal', team: 'team2', scorer: 'Václav Matějovič', assists: [], score: '4:5', overtime: true }
  ];
  ...
  // Určit vítěze
  const winner = 'team2'; // Litvínov vyhrál v prodloužení
      ...
      <div className="relative mt-28 mb-8 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 py-8">
          ...
          <div className="flex items-center gap-2 text-gray-400 mb-6">
            ...
            <ChevronRight className="w-4 h-4" />
            <span className="text-white font-bold">Zápas #5</span>
          </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <div className="text-sm text-yellow-400 font-bold uppercase tracking-wider mb-1">
                    {matchData.round} - PRODLOUŽENÍ
                  </div>
                  <h1 className="text-3xl font-black text-white">
                    Dramatické vítězství Litvínova!
                  </h1>
                </div>
              </div>
                    ...
                    <div className="relative">
                      ...
                      <div className="relative">
                        ...
                        <div className="text-center mt-2">
                          <span className="inline-flex items-center gap-2 px-3 py-1 bg-gradient-to-r from-yellow-500/20 to-orange-500/20 rounded-full border border-yellow-500/30">
                            <Sparkles className="w-4 h-4 text-yellow-400" />
                            <span className="text-sm text-yellow-400 font-bold uppercase">Prodloužení</span>
                          </span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="flex flex-col items-center gap-4">
                      ...
                      {winner === 'team2' && (
                        <div className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-green-500/20 to-emerald-500/20 rounded-full border border-green-500/30 backdrop-blur">
                          ...
                          <span className="text-sm font-black text-green-400 uppercase tracking-wider">Vítěz v prodloužení</span>
                        </div>
                      )}
                    </div>
                  </div>
                ...
                <div className="mt-8 pt-8 border-t border-white/10">
                  ...
                  <div className="flex items-center justify-center gap-6">
                    ...
                    <div className="relative group">
                      <div className="absolute inset-0 bg-gradient-to-r from-yellow-500 to-orange-500 rounded-xl blur-lg opacity-60 animate-pulse"></div>
                      <div className="relative bg-gradient-to-br from-yellow-500/20 to-orange-500/20 backdrop-blur rounded-xl p-4 border border-yellow-500/30">
                        <div className="text-xs text-yellow-400 mb-2 text-center font-bold uppercase tracking-wider">
                          Prodloužení
                        </div>
                  ...
                  <div className="mt-4 text-center">
                    <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-red-500/20 to-red-600/20 rounded-full border border-red-500/30">
                      ...
                      <span className="text-sm text-red-400 font-bold">
                        Václav Matějovič - hrdina prodloužení (čas 43:47)
                      </span>
                    </div>
                  </div>
                </div>
            ...
            <div className="space-y-3">
              {gameEvents.map((event, index) => (
                <div key={index} className={`group relative overflow-hidden rounded-xl transition-all ${
                  event.overtime ? 'bg-gradient-to-r from-yellow-500/20 to-orange-500/20 border-2 border-yellow-500/50 hover:border-yellow-400/70' :
                  event.type === 'goal' 
                    ? event.team === 'team1' 
                  ...
                  <div className="relative flex items-center gap-4 p-5">
                    ...
                    <div className="px-3 py-1 bg-black/30 rounded-full">
                      <span className="text-xs text-gray-300 font-bold">
                        {event.overtime ? 'PRODL.' : `${event.period}. třetina`}
                      </span>
                    </div>
                      ...
                      <>
                        ...
                        <div className="flex-1">
                          <span className={`font-black ${
                            event.overtime 
                              ? 'text-2xl bg-gradient-to-r from-yellow-400 to-orange-600 bg-clip-text text-transparent'
                              : event.team === 'team1' 
                                ? 'bg-gradient-to-r from-blue-400 to-blue-600 bg-clip-text text-transparent'
                                : 'bg-gradient-to-r from-red-400 to-red-600 bg-clip-text text-transparent'
                          }`}>
                            {event.overtime ? 'VÍTĚZNÝ GÓL! ' : 'GÓL! '}{event.scorer}
                          </span>
                  ...
                  {rosters.team2.forwards.map((player, i) => (
                    <div key={i} className="group flex items-center justify-between p-3 hover:bg-red-500/10 rounded-xl transition-all">
                      ...
                      <div className="flex items-center gap-2">
                        {player.goals > 0 && (
                          <span className="px-2 py-1 bg-green-500/20 rounded-lg text-green-400 text-xs font-bold">
                            {player.goals === 2 && player.name === 'Václav Matějovič' ? '2G ⚡' : `${player.goals}G`}
                          </span>
                        )}
                        {player.assists > 0 && (
                          <span className="px-2 py-1 bg-blue-500/20 rounded-lg text-blue-400 text-xs font-bold">
                ...
                <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-yellow-500/20 to-orange-500/20 border border-yellow-500/30 p-4">
                  ...
                  <div className="relative flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <div className="text-white font-black text-lg">Václav Matějovič</div>
                        <div className="text-yellow-400 text-sm font-semibold">HC Litvínov Lancers</div>
                      </div>
                    </div>
                    <div className="text-right">
                      <div className="text-3xl font-black bg-gradient-to-b from-yellow-400 to-orange-500 bg-clip-text text-transparent">2</div>
                      <div className="text-xs text-gray-400 font-bold uppercase">+ OT</div>
                    </div>
                  </div>
                </div>
                ...
                <div className="rounded-2xl bg-white/5 border border-white/10 p-4">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <div className="text-white font-bold">Peter Angrik</div>
                ...
                <div className="rounded-2xl bg-white/5 border border-white/10 p-4">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <div className="text-white font-bold">Marco Rensch</div>
                        <div className="text-blue-400 text-sm">Berlin All Stars</div>
                      </div>
                    </div>
                    <div className="text-right">
            ...
            <div className="backdrop-blur-xl bg-gradient-to-br from-purple-900/20 via-black/60 to-blue-900/20 border border-purple-500/30 rounded-3xl p-6 shadow-2xl">
              ...
              <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-purple-500/20 to-blue-500/20 border border-purple-500/30 p-6">
                <div className="absolute top-0 right-0">
                  <Trophy className="w-32 h-32 text-purple-500/10" />
                </div>
                <div className="relative">
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <div>
                      <div className="text-white font-black text-2xl">Václav Matějovič</div>
                      <div className="text-red-400 font-semibold">HC Litvínov Lancers</div>
                    </div>
                  </div>
                  <div className="grid grid-cols-3 gap-4">
                    ...
                    <div className="text-center bg-black/30 rounded-lg p-3">
                      ...
                      <div className="text-xs text-gray-400 uppercase">OT gól</div>
                    </div>
                    <div className="text-center bg-black/30 rounded-lg p-3">
                      <div className="text-2xl font-black text-green-400">43:47</div>
                      <div className="text-xs text-gray-400 uppercase">Čas</div>
                    </div>
                  </div>
                  <div className="mt-4 text-center">
                    <span className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-yellow-500/20 to-orange-500/20 rounded-full border border-yellow-500/30">
                      <Star className="w-5 h-5 text-yellow-400" />
                      <span className="text-sm text-yellow-400 font-bold">
                        Rozhodl dramatický zápas v prodloužení!
                      </span>
                    </span>
                  </div>
                </div>
