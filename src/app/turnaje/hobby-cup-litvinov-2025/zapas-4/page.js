...
export default function Zapas4Page() {
  // Data zápasu
  const matchData = {
    id: 4,
    ...
    referee: 'TBA',
    attendance: 'TBA',
    periods: ['0:1', '2:2'], // Jen 2 třetiny
    overtime: false,
    shootout: false,
    notes: 'Druhý sobotní zápas základní skupiny - hrálo se pouze na 2 třetiny po 20 minutách',
    duration: '2x20 minut'
  };
  ...
  const rosters = {
    team1: {
      ...
      defenders: [
        ...
        { number: '', name: 'Leon Wäser', position: 'Obránce' },
        { number: '', name: 'Marco Rensch', position: 'Obránce' },
        { number: '', name: 'Tim Bartsch', position: 'Obránce', penalties: 2 }
      ],
      forwards: [
        { number: '', name: 'Matthias Blaschzik', position: 'Útočník', penalties: 2 },
        { number: '', name: 'Frank Blaschzik', position: 'Útočník', penalties: 2 },
        { number: '', name: 'David Weiss', position: 'Útočník' },
        { number: '', name: 'Ricardo Pietsch', position: 'Útočník' },
        { number: '', name: 'Felix Schliemann', position: 'Útočník', goals: 2, assists: 0, penalties: 2 },
        { number: '', name: 'Daniel Pietsch', position: 'Útočník' },
        { number: '', name: 'Jan Fritche', position: 'Útočník', penalties: 2 },
        { number: '', name: 'Peter Angrik', position: 'Útočník', assists: 1 },
        { number: '', name: 'Daety Ertel', position: 'Útočník' }
      ]
    },
    team2: {
      name: 'Alpha Team B',
      ...
      defenders: [
        { number: '', name: 'Leonid Hansen', position: 'Obránce', penalties: 2 },
        { number: '', name: 'Alexander Zhiliaev', position: 'Obránce' },
        { number: '', name: 'Sergey Wotschel', position: 'Obránce' },
        { number: '', name: 'Artur Lishchynsky', position: 'Obránce' },
      ...
      forwards: [
        ...
        { number: '', name: 'Sergey Terechov', position: 'Útočník' },
        { number: '', name: 'Ivan Patayala', position: 'Útočník', goals: 2, assists: 0 },
        { number: '', name: 'Peter Eisele', position: 'Útočník' },
        { number: '', name: 'Andrey Esser', position: 'Útočník' },
        { number: '90', name: 'Igor Nalyotov', position: 'Útočník', goals: 1, assists: 1 },
  ...
  const gameEvents = [
    { time: '2:00', period: 1, type: 'penalty', team: 'team1', player: 'Matthias Blaschzik', reason: 'Hrubost', duration: 2 },
    { time: '14:00', period: 1, type: 'penalty', team: 'team1', player: 'Jan Fritche', reason: 'Sekání', duration: 2 },
    { time: '15:00', period: 1, type: 'goal', team: 'team2', scorer: 'Ivan Patayala', assists: [], score: '0:1' },
    { time: '19:00', period: 1, type: 'penalty', team: 'team1', player: 'Tim Bartsch', reason: 'Sekání', duration: 2 },
    { time: '29:00', period: 2, type: 'goal', team: 'team1', scorer: 'Felix Schliemann', assists: ['Peter Angrik'], score: '1:1' },
    { time: '30:00', period: 2, type: 'goal', team: 'team2', scorer: 'Ivan Patayala', assists: ['Igor Nalyotov'], score: '1:2' },
    { time: '32:00', period: 2, type: 'penalty', team: 'team1', player: 'Frank Blaschzik', reason: 'Trest', duration: 2 },
    { time: '34:00', period: 2, type: 'penalty', team: 'team2', player: 'Leonid Hansen', reason: 'Nedovolené bránění', duration: 2 },
    { time: '40:00', period: 2, type: 'goal', team: 'team2', scorer: 'Igor Nalyotov', assists: [], score: '1:3' },
    { time: '40:00', period: 2, type: 'goal', team: 'team1', scorer: 'Felix Schliemann', assists: [], score: '2:3' },
    { time: '40:00', period: 2, type: 'penalty', team: 'team1', player: 'Felix Schliemann', reason: 'Hrubost', duration: 2 }
  ];
      ...
      <div className="relative mt-28 mb-8 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 py-8">
          ...
          <div className="flex items-center gap-2 text-gray-400 mb-6">
            ...
            <ChevronRight className="w-4 h-4" />
            <span className="text-white font-bold">Zápas #4</span>
          </div>
                    ...
                    <div className="flex flex-col items-center gap-4">
                      ...
                      {winner === 'team2' && (
                        <div className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-green-500/20 to-emerald-500/20 rounded-full border border-green-500/30 backdrop-blur">
                          ...
                          <span className="text-sm font-black text-green-400 uppercase tracking-wider">Vítěz</span>
                        </div>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="mt-8 pt-8 border-t border-white/10">
                    ...
                    <div className="mt-4 text-center">
                      <span className="text-xs text-orange-400 font-bold">
                        Dramatický závěr - dva góly v poslední minutě!
                      </span>
                    </div>
                  </div>
                )}
      ...
      <div className="max-w-7xl mx-auto px-4 pb-20">
        ...
        {activeTab === 'soupisky' && (
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            {/* Alpha Team B */}
            <div className="backdrop-blur-xl bg-gradient-to-br from-green-900/20 via-black/60 to-green-900/20 border border-green-500/30 rounded-3xl overflow-hidden shadow-2xl">
              <div className="p-5 bg-gradient-to-r from-green-600 to-green-700">
                <h3 className="text-xl font-black text-white flex items-center gap-3">
              ...
              <div className="p-6">
                <div className="mb-6">
                  <h4 className="text-xs font-black text-green-400 mb-4 uppercase tracking-wider">Brankáři</h4>
                  {rosters.team2.goalies.map((player, i) => (
                    <div key={i} className="group flex items-center gap-3 p-3 hover:bg-green-500/10 rounded-xl transition-all">
                ...
                <div className="mb-6">
                  <h4 className="text-xs font-black text-green-400 mb-4 uppercase tracking-wider">Obránci</h4>
                  {rosters.team2.defenders.map((player, i) => (
                    <div key={i} className="group flex items-center justify-between p-3 hover:bg-green-500/10 rounded-xl transition-all">
                      <div className="flex items-center gap-3">
                        <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-gray-600 to-gray-700 flex items-center justify-center">
                          <User className="w-4 h-4 text-white" />
                        </div>
                ...
                <div>
                  <h4 className="text-xs font-black text-green-400 mb-4 uppercase tracking-wider">Útočníci</h4>
                ...
                <div className="rounded-2xl bg-white/5 border border-white/10 p-4">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <div className="text-white font-bold">Felix Schliemann</div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <div className="text-green-400 text-sm">Alpha Team B</div>
                      </div>
                    </div>
                    <div className="text-right">
              ...
              <div className="space-y-3">
                <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-purple-500/20 to-blue-500/20 border border-purple-500/30 p-4">
                  ...
                  <div className="relative flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <div className="text-white font-black text-lg">Ivan Patayala</div>
                        <div className="text-purple-400 text-sm font-semibold">Alpha Team B</div>
                      </div>
                    </div>
                    <div className="text-right">
                      <div className="text-3xl font-black bg-gradient-to-b from-purple-400 to-blue-500 bg-clip-text text-transparent">2</div>
                ...
                <div className="rounded-2xl bg-white/5 border border-white/10 p-4">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-right">
                      <div className="text-2xl font-black text-white">2</div>
                      <div className="text-xs text-gray-400 font-bold">1G + 1A</div>
                    </div>
                  </div>
                </div>
              </div>
