...
export default function Zapas6Page() {
  // Data zápasu
  const matchData = {
    id: 6,
    ...
    referee: 'TBA',
    attendance: 'TBA',
    periods: ['5:3', '1:2'], // Jen 2 třetiny
    overtime: false,
    shootout: false,
    notes: 'Německé derby - poslední zápas základní skupiny!',
    duration: '2x20 minut'
  };
  ...
  const rosters = {
    team1: {
      ...
      defenders: [
        { number: '', name: 'Alexander Hermann', position: 'Obránce', goals: 1, assists: 0, penalties: 2 },
        { number: '', name: 'Dennis Hermann', position: 'Obránce' },
        { number: '', name: 'Maurice Giese', position: 'Obránce' },
        { number: '', name: 'Nikita Helm', position: 'Obránce', goals: 1, assists: 0 },
        { number: '', name: 'Mark Wassermann', position: 'Obránce', goals: 2, assists: 0, penalties: 2 }
      ],
      forwards: [
        { number: '', name: 'Alexander Plinger', position: 'Útočník', goals: 2, assists: 1 },
        { number: '', name: 'Andrey Schapovalov', position: 'Útočník' },
        { number: '', name: 'Dennis Schuller', position: 'Útočník' },
        { number: '', name: 'Sergey Schnarr', position: 'Útočník', assists: 2 },
        { number: '', name: 'Nikita Kulpin', position: 'Útočník' },
        { number: '', name: 'Igor Nalyotov', position: 'Útočník' }
      ]
    },
    team2: {
      name: 'Alpha Team B',
      ...
      defenders: [
        ...
        { number: '', name: 'Alexander Zhiliaev', position: 'Obránce', assists: 1 },
        { number: '', name: 'Sergey Wotschel', position: 'Obránce', penalties: 2 },
        { number: '', name: 'Artur Lishchynsky', position: 'Obránce', goals: 2, assists: 0 },
        { number: '', name: 'Leon Patz', position: 'Obránce', goals: 1, assists: 0 }
      ],
      forwards: [
        { number: '', name: 'Vladimir Visner', position: 'Útočník' },
        { number: '', name: 'Sergey Antipov', position: 'Útočník' },
        { number: '', name: 'Sergey Terechov', position: 'Útočník', goals: 1, assists: 1 },
        { number: '', name: 'Ivan Patayala', position: 'Útočník', assists: 2 },
  ...
  const gameEvents = [
    { time: '1:00', period: 1, type: 'goal', team: 'team2', scorer: 'Leonid Hansen', assists: ['Ivan Patayala'], score: '0:1' },
    { time: '2:00', period: 1, type: 'goal', team: 'team1', scorer: 'Alexander Hermann', assists: ['Sergey Schnarr'], score: '1:1' },
    { time: '4:00', period: 1, type: 'penalty', team: 'team1', player: 'Alexander Hermann', reason: 'Hrubost', duration: 2 },
    { time: '10:00', period: 1, type: 'goal', team: 'team2', scorer: 'Sergey Terechov', assists: ['Ivan Patayala'], score: '1:2' },
    { time: '11:00', period: 1, type: 'goal', team: 'team1', scorer: 'Alexander Plinger', assists: [], score: '2:2' },
    { time: '12:00', period: 1, type: 'goal', team: 'team1', scorer: 'Alexander Plinger', assists: ['Sergey Schnarr'], score: '3:2' },
    { time: '13:00', period: 1, type: 'goal', team: 'team1', scorer: 'Mark Wassermann', assists: [], score: '4:2' },
    { time: '17:00', period: 1, type: 'goal', team: 'team1', scorer: 'Nikita Helm', assists: [], score: '5:2' },
    { time: '19:00', period: 1, type: 'goal', team: 'team2', scorer: 'Artur Lishchynsky', assists: [], score: '5:3' },
    { time: '24:00', period: 2, type: 'goal', team: 'team1', scorer: 'Mark Wassermann', assists: ['Alexander Plinger'], score: '6:3' },
    { time: '26:00', period: 2, type: 'penalty', team: 'team2', player: 'Sergey Wotschel', reason: 'Hrubost', duration: 2 },
    { time: '34:00', period: 2, type: 'penalty', team: 'team1', player: 'Mark Wassermann', reason: 'Hrubost', duration: 2 },
    { time: '37:00', period: 2, type: 'goal', team: 'team2', scorer: 'Leon Patz', assists: ['Alexander Zhiliaev'], score: '6:4' },
    { time: '40:00', period: 2, type: 'goal', team: 'team2', scorer: 'Artur Lishchynsky', assists: ['Sergey Terechov'], score: '6:5' }
  ];
      ...
      <div className="relative mt-28 mb-8 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 py-8">
          ...
          <div className="flex items-center gap-2 text-gray-400 mb-6">
            ...
            <ChevronRight className="w-4 h-4" />
            <span className="text-white font-bold">Zápas #6</span>
          </div>
          ...
          <div className="relative backdrop-blur-xl bg-gradient-to-br from-black/60 via-gray-900/60 to-black/60 border border-white/10 rounded-3xl p-8 shadow-2xl">
            ...
            <div className="flex items-center justify-between mb-8">
              <div className="flex items-center gap-4">
                <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-black to-red-900 flex items-center justify-center shadow-lg">
                  <div className="flex">
                    ...
                    <div className="relative">
                      ...
                      <div className="relative">
                        ...
                        <div className="text-center mt-2">
                          <span className="text-xs text-gray-400 font-bold uppercase">11 gólů celkem!</span>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="mt-8 pt-8 border-t border-white/10">
                    ...
                    <div className="mt-4 text-center">
                      <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-yellow-500/20 to-orange-500/20 rounded-full border border-yellow-500/30">
                        ...
                        <span className="text-sm text-yellow-400 font-bold">
                          Ofenzivní podívaná - 8 gólů v první třetině!
                        </span>
                      </div>
                    </div>
                  </div>
      ...
      <div className="max-w-7xl mx-auto px-4 pb-20">
        {activeTab === 'prehled' && (
          <div className="backdrop-blur-xl bg-gradient-to-br from-black/60 via-gray-900/60 to-black/60 border border-white/10 rounded-3xl p-8 shadow-2xl">
            ...
            {/* Dramatický závěr */}
            <div className="mt-6 p-4 bg-gradient-to-r from-orange-500/10 to-red-500/10 rounded-xl border border-orange-500/30">
              <div className="flex items-center gap-3">
                <Sparkles className="w-6 h-6 text-orange-400" />
                <div>
                  <div className="text-sm font-black text-orange-400 uppercase">Dramatický závěr!</div>
                  <div className="text-xs text-gray-400">Alpha Team B se snažil o vyrovnání, ale čas vypršel při skóre 6:5</div>
                </div>
              </div>
            </div>
          </div>
                ...
                <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-yellow-500/20 to-orange-500/20 border border-yellow-500/30 p-4">
                  ...
                  <div className="relative flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <div className="text-white font-black text-lg">Alexander Plinger</div>
                ...
                <div className="rounded-2xl bg-white/5 border border-white/10 p-4">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <div className="text-white font-bold">Mark Wassermann</div>
                ...
                <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-purple-500/20 to-blue-500/20 border border-purple-500/30 p-4">
                  ...
                  <div className="relative flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <div className="text-white font-black text-lg">Alexander Plinger</div>
                        <div className="text-purple-400 text-sm font-semibold">Alpha Team A</div>
                      </div>
                    </div>
                    <div className="text-right">
                ...
                <div className="rounded-2xl bg-white/5 border border-white/10 p-4">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <div className="text-white font-bold">Sergey Schnarr</div>
                        <div className="text-red-400 text-sm">Alpha Team A</div>
                      </div>
                    </div>
                    <div className="text-right">
