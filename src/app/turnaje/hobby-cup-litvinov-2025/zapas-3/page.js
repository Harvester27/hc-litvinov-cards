...
export default function Zapas3Page() {
  // Data zápasu
  const matchData = {
    id: 3,
    ...
    referee: 'TBA',
    attendance: 'TBA',
    periods: ['1:0', '4:1'], // Jen 2 třetiny
    overtime: false,
    shootout: false,
    notes: 'Skvělé vítězství domácího týmu - Václav Matějovič dal 4 góly!',
    duration: '2x20 minut'
  };
  ...
  const rosters = {
    team1: {
      ...
      defenders: [
        ...
        { number: '54', name: 'Ondřej Kocourek', position: 'Obránce', penalties: 4 }, // 2x2 minuty
        { number: '3', name: 'Jiří Šalanda', position: 'Obránce' }
      ],
      forwards: [
        { number: '67', name: 'Gustav Toman', position: 'Útočník', penalties: 2 },
        { number: '98', name: 'Václav Matějovič', position: 'Útočník', goals: 4, assists: 0 },
        { number: '95', name: 'Jan Švarc', position: 'Útočník', assists: 1 },
        { number: '94', name: 'Stanislav Švarc', position: 'Útočník', assists: 2 },
    ...
    team2: {
      ...
      defenders: [
        ...
        { number: '67', name: 'Dennis Hermann', position: 'Obránce', penalties: 2 },
        { number: '74', name: 'Maurice Giese', position: 'Obránce' },
        { number: '78', name: 'Nikita Helm', position: 'Obránce', goals: 1, assists: 0 },
        { number: '89', name: 'Mark Wassermann', position: 'Obránce' }
      ],
      forwards: [
        { number: '47', name: 'Alexander Plinger', position: 'Útočník', penalties: 2 },
        { number: '77', name: 'Andrey Schapovalov', position: 'Útočník' },
        { number: '55', name: 'Dennis Schuller', position: 'Útočník', penalties: 2 },
  ...
  const gameEvents = [
    { time: '6:00', period: 1, type: 'penalty', team: 'team2', player: 'Dennis Schuller', reason: 'Krosček', duration: 2 },
    { time: '9:00', period: 1, type: 'goal', team: 'team1', scorer: 'Václav Matějovič', assists: ['Jan Švarc'], score: '1:0' },
    { time: '20:00', period: 1, type: 'penalty', team: 'team1', player: 'Gustav Toman', reason: 'Hákování', duration: 2 },
    { time: '20:00', period: 1, type: 'penalty', team: 'team2', player: 'Alexander Plinger', reason: 'Držení hole', duration: 2 },
    { time: '21:00', period: 2, type: 'penalty', team: 'team2', player: 'Dennis Hermann', reason: 'Nedovolené bránění', duration: 2 },
    { time: '22:00', period: 2, type: 'goal', team: 'team1', scorer: 'Michal Klečka', assists: [], score: '2:0' },
    { time: '25:00', period: 2, type: 'penalty', team: 'team1', player: 'Ondřej Kocourek', reason: 'Podražení', duration: 2 },
    { time: '25:00', period: 2, type: 'goal', team: 'team2', scorer: 'Nikita Helm', assists: [], score: '2:1' },
    { time: '27:00', period: 2, type: 'goal', team: 'team1', scorer: 'Václav Matějovič', assists: [], score: '3:1' },
    { time: '29:00', period: 2, type: 'goal', team: 'team1', scorer: 'Václav Matějovič', assists: ['Stanislav Švarc'], score: '4:1' },
    { time: '35:00', period: 2, type: 'goal', team: 'team1', scorer: 'Václav Matějovič', assists: ['Stanislav Švarc'], score: '5:1' },
    { time: '38:00', period: 2, type: 'penalty', team: 'team1', player: 'Ondřej Kocourek', reason: 'Podražení', duration: 2 }
  ];
      ...
      <div className="relative mt-28 mb-8 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 py-8">
          ...
          <div className="flex items-center gap-2 text-gray-400 mb-6">
            ...
            <ChevronRight className="w-4 h-4" />
            <span className="text-white font-bold">Zápas #3</span>
          </div>
          ...
          <div className="relative backdrop-blur-xl bg-gradient-to-br from-black/60 via-gray-900/60 to-black/60 border border-white/10 rounded-3xl p-8 shadow-2xl">
            ...
            <div className="flex items-center justify-between mb-8">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <div className="text-sm text-red-400 font-bold uppercase tracking-wider mb-1">
                    {matchData.round}
                  </div>
                  ...
                  <div className="mt-8 pt-8 border-t border-white/10">
                    ...
                    <div className="flex items-center justify-center gap-6">
                      {matchData.periods.map((period, index) => (
                        <div key={index} className="relative group">
                          <div className="absolute inset-0 bg-gradient-to-r from-red-500 to-red-600 rounded-xl blur-lg opacity-40 group-hover:opacity-60 transition-opacity"></div>
                    ...
                    <div className="mt-4 text-center">
                      <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-yellow-500/20 to-orange-500/20 rounded-full border border-yellow-500/30">
                        ...
                        <span className="text-sm text-yellow-400 font-bold">
                          Václav Matějovič - 4 góly v zápase!
                        </span>
                      </div>
                    </div>
                  </div>
                ...
                <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-yellow-500/20 to-orange-500/20 border border-yellow-500/30 p-4">
                  ...
                  <div className="relative flex items-center justify-between">
                    ...
                    <div className="text-right">
                      <div className="text-3xl font-black bg-gradient-to-b from-yellow-400 to-orange-500 bg-clip-text text-transparent">4</div>
              ...
              <div className="space-y-3">
                <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-purple-500/20 to-blue-500/20 border border-purple-500/30 p-4">
                  ...
                  <div className="relative flex items-center justify-between">
                    ...
                    <div className="text-right">
                      <div className="text-3xl font-black bg-gradient-to-b from-purple-400 to-blue-500 bg-clip-text text-transparent">4</div>
                      <div className="text-xs text-gray-400 font-bold">4G + 0A</div>
                    </div>
                  </div>
                </div>
                ...
                <div className="rounded-2xl bg-white/5 border border-white/10 p-4">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <div className="text-white font-bold">Stanislav Švarc</div>
                        <div className="text-red-400 text-sm">HC Litvínov Lancers</div>
                      </div>
                    </div>
                    <div className="text-right">
