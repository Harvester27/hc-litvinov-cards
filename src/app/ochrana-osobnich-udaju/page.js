    ...
    <div className={styles.page}>
      ...
      <main className={styles.main}>
        ...
        <section className={styles.section} aria-labelledby="purpose-heading">
          ...
          <p>Účet a herní profil vedeme, abychom ti mohli poskytnout přihlášení a hru, o které sis řekl(a). Stejně tak zveřejníme komentář, který se rozhodneš vložit do diskuse. Právním základem pro tyto funkce je poskytování služby podle čl. 6 odst. 1 písm. b) GDPR.</p>
